...
model = dict(
    ...
    cls_head=dict(num_classes=20), #num_classes=174
    test_cfg=dict(max_testing_views=2), 
    train_cfg=dict(blending=dict(type='LabelSmoothing', num_classes=20, smoothing=0.1))) #num_classes=174

# dataset settings
dataset_type = 'VideoDataset'
data_root = 'path_to_dataset'
data_root_val = 'path_to_dataset'
ann_file_train = 'path_to_train_label_list'
ann_file_val = 'path_to_val_label_list'
ann_file_test = 'path_to_val_label_list'
img_norm_cfg = dict(
