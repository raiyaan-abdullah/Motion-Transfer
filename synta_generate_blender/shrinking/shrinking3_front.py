...
def animate_object(obj):
    start_frame = 1
    end_frame = 60
    scale_factor = 3  # Define how much larger the object becomes, 1.2 times its original size

    # Set initial location and scale keyframes at the start frame
    obj.location.y = 0
    obj.scale = (scale_factor, scale_factor, scale_factor)  # Starting scale
...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\shrinking3_front_id_{i+1}.mp4"  # Unique filename for each video
        ...
        obj2.location = (4, 4, 3)   # Move obj2 to the right
