...
def animate_object(obj):
    start_frame = 1
    end_frame = 60
    scale_factor = 4  # Define how much larger the object becomes, 1.2 times its original size
    ...
    obj.scale = (0.3, 0.3, 0.3)  # Ending scale
...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\shrinking2_front_id_{i+1}.mp4"  # Unique filename for each video
