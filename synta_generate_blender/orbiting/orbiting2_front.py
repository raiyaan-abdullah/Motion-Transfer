...
def animate_object(obj, central_obj):
    ...
    for frame in range(start_frame, end_frame + 1):
        ...
        y = central_obj.location.y + radius * math.sin(angle)  # Positive sine for counter-clockwise
...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        output_file_path = f"{base_path}\\orbiting2_front_id_{i+1}.mp4"  # Adjust path as necessary
        ...
        central_obj = create_random_object_set2()  # Central object that others will orbit
        central_obj.location = (0, 0, 1)  # Place at the center of the scene
        orbiting_obj = create_random_object_set2()  # Assuming this creates a new object
