...
def setup_camera(target):
    ...
    z = random.uniform(10, 25)  # Adjust the Z to change the height of the camera
...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\cloning3_id_{i+1}.mp4"  # Unique filename for each video
