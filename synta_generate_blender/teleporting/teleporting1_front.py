...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\teleporting1_front_id_{i+1}.mp4"  # Unique filename for each video
        ...
        animate_fade_move_reappear(obj, start_frame=10, fade_frame=40, reappear_frame=60, end_frame=90)
