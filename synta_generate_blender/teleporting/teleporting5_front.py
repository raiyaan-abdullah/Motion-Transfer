...
def animate_fade_move_reappear(obj, start_frame, fade_frame, reappear_frame, end_frame):
    ...
    obj.location = (-8, -8, 1)  # Move to the opposite side within the camera's view
...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\teleporting5_front_id_{i+1}.mp4"  # Unique filename for each video
        ...
        animate_fade_move_reappear(obj1, start_frame=10, fade_frame=40, reappear_frame=60, end_frame=90)
