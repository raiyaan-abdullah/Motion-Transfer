...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\shooting_projectile1_front_id_{i+1}.mp4"  # Unique filename for each video
        ...
        animate_projectile_trajectory(obj1, start_location=(-7, -7, 1), initial_velocity= 11.5, launch_angle_degrees= 45)
