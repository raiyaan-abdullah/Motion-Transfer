...
def create_plane():
    ...
    # Create or retrieve the ground material
    ...
    bsdf.inputs['Alpha'].default_value = 0.1  # 50% transparency
    ...
    ground_material.shadow_method = 'HASHED'
...
# Animate the object moving into view
def animate_projectile_trajectory_reverse(obj, start_location, initial_velocity, launch_angle_degrees, gravity=-9.81, frame_rate=24):
    """
    Animate the trajectory of a projectile in Blender.
...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\shooting_projectile5_front_id_{i+1}.mp4"  # Unique filename for each video
        ...
        animate_projectile_trajectory_reverse(obj1, start_location=(9, 5, 1), initial_velocity= 11.5, launch_angle_degrees= 45)
        animate_projectile_trajectory(obj2, start_location=(-9, -5, 1), initial_velocity= 11.5, launch_angle_degrees= 45)
