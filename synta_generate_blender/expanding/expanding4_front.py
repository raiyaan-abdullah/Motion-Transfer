...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\expanding4_front_id_{i+1}.mp4"  # Unique filename for each video
        ...
        obj1.location = (-3, -3, 1)  # Move obj1 to the left
        obj2.location = (6, 6, 1)   # Move obj2 to the right
        ...
        animate_object(obj1, 3.5)  # Object 1 expands more
        animate_object(obj2, 1.5)  # Object 2 expands less
