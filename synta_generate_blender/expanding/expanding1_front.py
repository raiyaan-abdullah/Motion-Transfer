...
def animate_object(obj):
    start_frame = 1
    end_frame = 60
    scale_factor = 1.5  # Define how much larger the object becomes, 1.2 times its original size
...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\expanding1_front_id_{i+1}.mp4"  # Unique filename for each video
