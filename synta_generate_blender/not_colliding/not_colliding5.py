...
def setup_camera(target):
    ...
    z = random.uniform(10, 30)  # Adjust the Z to change the height of the camera
...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\not_colliding5_id_{i+1}.mp4"  # Unique filename for each video
        ...
        static_obj_locations = [
            (-5, -5, 1),  # Position for the first stationary object
            (5, -5, 1),   # Position for the second stationary object
            (0, 5, 1)     # Position for the third stationary object
        ]
        ...
        waypoints_moving_obj = [(-20, 0, 1), (0, 0, 1), (20, 0, 1)]
