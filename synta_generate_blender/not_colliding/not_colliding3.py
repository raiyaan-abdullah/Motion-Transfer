...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\not_colliding3_id_{i+1}.mp4"  # Unique filename for each video
        ...
        waypoints_obj1 = [(-20, -2, 1), (-2, -2, 1), (20, -2, 1)]
        waypoints_obj2 = [(20, 2, 1), (2, 2, 1), (-20, 2, 1)]
        waypoints_obj3 = [(30, 20, 1), (-10, 5, 1), (-20, -20, 1)]
        waypoints_obj4 = [(-20, -20, 1), (10, 0, 1), (20, 20, 1)]
