...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\not_colliding2_front_id_{i+1}.mp4"  # Unique filename for each video
        ...
        stationary_obj.location = (0, -2, 0)  # Position the stationary object

        # Define the animation path waypoints and frames for the moving object
        waypoints_moving_obj = [(-20, 2, 3), (0, 2, 3), (20, 2, 3)]
