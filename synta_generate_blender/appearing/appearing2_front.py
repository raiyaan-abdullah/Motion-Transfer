...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}/appearing2_front_id_{i+1}.mp4"  # Use forward slashes for compatibility
        ...
        # Create 4 random objects at specific locations
        for location in locations:
            obj = create_random_object_basic_set1()
            # Set each object's location
            obj.location = location

            # Optionally, apply the fade-out animation to each object
