...
def animate_smooth_color_change(obj, start_frame, color_change_end_frame, total_end_frame):
    ...
    initial_color = dark_color()  # Get a bright color
    final_color = bright_color()  # Get a dark color
...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\changing_color4_front_id_{i+1}.mp4"  # Unique filename for each video
