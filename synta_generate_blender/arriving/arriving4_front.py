...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\arriving4_front_id_{i+1}.mp4"  # Unique filename for each video
        ...
        start_location = (0, -40, 1)
        end_location = (0, 0, 1)  # Mid-point where the object will slow or pause
        ...
        animate_object(moving_obj, start_location, end_location, start_frame, end_frame)
