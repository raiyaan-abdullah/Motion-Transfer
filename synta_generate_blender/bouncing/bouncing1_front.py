...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\bouncing1_front_id_{i+1}.mp4"  # Unique filename for each video
        ...
        animate_bouncing(obj, start_frame=1, end_frame=120, start_height=4, floor_level=1, bounces=4)
