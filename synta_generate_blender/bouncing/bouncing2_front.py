...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\bouncing2_front_id_{i + 1}.mp4"  # Unique filename for each video
        ...
        start_positions = [(6, 0, 1), (2, 0, 1), (-2, 0, 1), (-6, 0, 1)]  # Starting positions for each object
