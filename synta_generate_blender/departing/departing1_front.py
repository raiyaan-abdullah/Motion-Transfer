...
def animate_object(obj):
    ...
    # Starting position of the object (off-camera)
    obj.location.y = 0
    obj.keyframe_insert(data_path="location", frame=start_frame)
    
    # Ending position of the object (center of the scene)
    obj.location.y = -30
...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\departing1_front_id_{i+1}.mp4"  # Unique filename for each video
