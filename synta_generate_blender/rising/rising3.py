...
def generate_videos(base_path, number_of_videos=100):
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\rising3_id_{i+1}.mp4"  # Unique filename for each video
        ...
        animate_rising_diagonal(obj1, start_position=(-7, 0, 1), end_position=(8, 1, 8), start_frame=1, end_frame=60)
