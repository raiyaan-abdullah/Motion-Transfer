...
def animate_rising_object(obj, start_height, end_height, start_frame, end_frame):
    """
...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\rising1_front_id_{i+1}.mp4"  # Unique filename for each video
        ...
        obj1.location = (0, 0, 1)   # Start 5 units above the ground
        ...
        animate_rising_object(obj1, start_height=1, end_height=12, start_frame=1, end_frame=60)
