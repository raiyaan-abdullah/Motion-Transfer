...
def generate_videos(base_path, number_of_videos=100):
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\rising1_id_{i+1}.mp4"  # Unique filename for each video
        ...
        animate_rising_object(obj1, start_height=1, end_height=8, start_frame=1, end_frame=60)
