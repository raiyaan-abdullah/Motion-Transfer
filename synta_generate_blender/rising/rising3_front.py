...
def animate_rising_diagonal(obj, start_position, end_position, start_frame, end_frame):
    """
    Animates an object rising in a straight line from a start position to an end position.
...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\rising3_front_id_{i+1}.mp4"  # Unique filename for each video
        ...
        animate_rising_diagonal(obj1, start_position=(-7, 0, 1), end_position=(8, 1, 10), start_frame=1, end_frame=60)
