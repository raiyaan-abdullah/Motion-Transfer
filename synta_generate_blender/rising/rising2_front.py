...
def generate_videos(base_path, number_of_videos=50):
    ...
    for i in range(number_of_videos):
        ...
        output_file_path = f"{base_path}\\rising2_front_id_{i+1}.mp4"  # Unique filename for each video
        ...
        animate_rising_object_zigzag(obj1, start_height=1, end_height=14, start_frame=1, end_frame=120, lateral_distance=4, steps=7)
