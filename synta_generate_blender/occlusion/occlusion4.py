...
def generate_videos(base_path, number_of_videos=100):
    for i in range(number_of_videos):
        output_file_path = f"{base_path}\\occlusion4_id_{i+1}.mp4"
        ...
        # Create two objects
        obj1, obj1_shape = create_random_object()
        obj2, obj2_shape = create_random_object()
        ...
        # Create two objects
        obj3, obj3_shape = create_random_object()
        obj4, obj4_shape = create_random_object()
